...
@Component({
  selector: 'TaxDetail-home',
  templateUrl: './TaxDetail-home.component.html',
  styleUrls: ['./TaxDetail-home.component.scss']
})
export class TaxDetailHomeComponent implements AfterViewInit {
