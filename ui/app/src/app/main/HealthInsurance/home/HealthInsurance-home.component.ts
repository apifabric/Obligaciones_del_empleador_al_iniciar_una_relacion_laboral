...
@Component({
  selector: 'HealthInsurance-home',
  templateUrl: './HealthInsurance-home.component.html',
  styleUrls: ['./HealthInsurance-home.component.scss']
})
export class HealthInsuranceHomeComponent implements AfterViewInit {
