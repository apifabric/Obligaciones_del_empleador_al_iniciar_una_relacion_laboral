...
@Component({
  selector: 'WorkplaceSafety-home',
  templateUrl: './WorkplaceSafety-home.component.html',
  styleUrls: ['./WorkplaceSafety-home.component.scss']
})
export class WorkplaceSafetyHomeComponent implements AfterViewInit {
