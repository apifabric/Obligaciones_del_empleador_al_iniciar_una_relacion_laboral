...
@Component({
  selector: 'LeaveEntitlement-home',
  templateUrl: './LeaveEntitlement-home.component.html',
  styleUrls: ['./LeaveEntitlement-home.component.scss']
})
export class LeaveEntitlementHomeComponent implements AfterViewInit {
