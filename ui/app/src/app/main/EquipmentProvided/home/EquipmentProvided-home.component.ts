...
@Component({
  selector: 'EquipmentProvided-home',
  templateUrl: './EquipmentProvided-home.component.html',
  styleUrls: ['./EquipmentProvided-home.component.scss']
})
export class EquipmentProvidedHomeComponent implements AfterViewInit {
