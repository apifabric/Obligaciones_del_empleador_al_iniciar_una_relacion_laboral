...
resourcename="obligacionesdelempleadoraliniciarunarelacionlaboral"  # lower case, only
resourcegroup="obligacionesdelempleadoraliniciarunarelacionlaboral_rg"
...
# git clone https://github.com/apilogicserver/obligacionesdelempleadoraliniciarunarelacionlaboral.git
# cd obligacionesdelempleadoraliniciarunarelacionlaboral
...
az group create --name obligacionesdelempleadoraliniciarunarelacionlaboral_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group obligacionesdelempleadoraliniciarunarelacionlaboral_rg --sku S1 --is-linux
az container create --resource-group obligacionesdelempleadoraliniciarunarelacionlaboral_rg --name obligacionesdelempleadoraliniciarunarelacionlaboral --image apilogicserver/obligacionesdelempleadoraliniciarunarelacionlaboral:latest --dns-name-label obligacionesdelempleadoraliniciarunarelacionlaboral --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//obligacionesdelempleadoraliniciarunarelacionlaboral.westus.azurecontainer.io:5656'
